(function () {
  ...
  const SERVICE_VALUES = {
    "Landing page (візитівка)": 300,
    "Корпоративний сайт": 550,
    "Інтернет-магазин": 1350,
    "Мобільний додаток": 1200,
    "Мобільний додаток — Стартовий ($1 200)": 1200,
    "Мобільний додаток — Бізнес ($2 500)": 2500,
    "Мобільний додаток — Преміум ($5 000)": 5000,
    "Мобільний додаток — Індивідуальний розрахунок": 1200,
    Консультація: 0,
